...
def _compose_observed_weather(
    ...
    weather = {
        ...
        "metar_station": metar_observation.station_identifier,
        "metar_raw": metar_observation.raw_record,
        "metar_timestamp": metar_observation.timestamp,
        "goes_cloud_cover": goes_observation.high_cloud_cover,
        "goes_cloud_cover_kind": "high" if math.isfinite(goes_observation.high_cloud_cover) else "",
        "goes_altitude_category": "high" if math.isfinite(goes_observation.high_cloud_cover) else "",
        "goes_cloud_cover_grid": list(goes_observation.cloud_cover_grid),
        "goes_cloud_optical_thickness": goes_observation.cloud_optical_thickness,
